...
func (r LiveStreamApiGetLiveStreamKeysRequest) Type_(type_ string) LiveStreamApiGetLiveStreamKeysRequest {
	r.type_ = &type_
	return r
}
...
type LiveStreamServiceI interface {
	 ...
	 * @return LiveStreamApiUploadThumbnailRequest
	 */
	 ...
	 * @param id live stream media's id
	 * @return LiveStreamApiDeleteThumbnailRequest
	 */
	 ...
	 * @return LiveStreamApiDeleteLiveStreamMulticastRequest
	 */
	 ...
	 * @param streamKey Live stream key. UUID string format
	 * @return LiveStreamApiGetLiveStreamMulticastByStreamKeyRequest
	 */
	 ...
	 * @return LiveStreamApiGetLiveStreamStatisticByStreamMediaIdRequest
	 */
...
func (s *LiveStreamService) UploadThumbnailFile(id string, file *os.File) (*ResponseSuccess, error) {
...
func (s *LiveStreamService) UploadThumbnailFileWithContext(ctx context.Context, id string, file *os.File) (*ResponseSuccess, error) {
...
* @return LiveStreamApiUploadThumbnailRequest
 */
func (s *LiveStreamService) UploadThumbnail(id string, fileName string, fileReader io.Reader) (*ResponseSuccess, error) {
 ...
 * @return LiveStreamApiUploadThumbnailRequest
 */
func (s *LiveStreamService) UploadThumbnailWithContext(ctx context.Context, id string, fileName string, fileReader io.Reader) (*ResponseSuccess, error) {
	localVarPath := "/live_streams/{id}/thumbnail"
...
func (s *LiveStreamService) DeleteThumbnail(id string) (*ResponseSuccess, error) {
...
func (s *LiveStreamService) DeleteThumbnailWithContext(ctx context.Context, id string) (*ResponseSuccess, error) {
...
func (s *LiveStreamService) DeleteLiveStreamMulticast(streamKey string) (*ResponseSuccess, error) {

	return s.DeleteLiveStreamMulticastWithContext(context.Background(), streamKey)
...
func (s *LiveStreamService) DeleteLiveStreamMulticastWithContext(ctx context.Context, streamKey string) (*ResponseSuccess, error) {
	var localVarPostBody interface{}
...
func (s *LiveStreamService) GetLiveStreamMulticastByStreamKey(streamKey string) (*GetLiveStreamMulticastResponse, error) {

	return s.GetLiveStreamMulticastByStreamKeyWithContext(context.Background(), streamKey)
...
func (s *LiveStreamService) GetLiveStreamMulticastByStreamKeyWithContext(ctx context.Context, streamKey string) (*GetLiveStreamMulticastResponse, error) {
	var localVarPostBody interface{}
...
func (s *LiveStreamService) GetLiveStreamPlayerInfoWithContext(ctx context.Context, id string) (*GetLiveStreamVideoPublicResponse, error) {
	...
	localVarPath := "/live_streams/player/{id}/media"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterToString(id, "")), -1)
...
func (s *LiveStreamService) GetLiveStreamStatisticByStreamMediaId(streamMediaId string) (*GetLiveStreamStatisticResponse, error) {

	return s.GetLiveStreamStatisticByStreamMediaIdWithContext(context.Background(), streamMediaId)
...
func (s *LiveStreamService) GetLiveStreamStatisticByStreamMediaIdWithContext(ctx context.Context, streamMediaId string) (*GetLiveStreamStatisticResponse, error) {
	var localVarPostBody interface{}
...
func (s *LiveStreamService) GetMediasWithContext(ctx context.Context, id string, data GetLiveStreamMediasRequest) (*GetLiveStreamMediasResponse, error) {
	...
	localVarPath := "/live_streams/{id}/media"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterToString(id, "")), -1)
