 ...
 * @return PlayersApiUploadLogoRequest
 */
func (s *PlayersService) UploadLogo(id string, link string, fileName string, fileReader io.Reader) (*UploadLogoByIdResponse, error) { 	return s.UploadLogoWithContext(context.Background(), id, link, fileName, fileReader)
}
