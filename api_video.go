 ...
 * @return VideoApiUploadThumbnailRequest
 */
func (s *VideoService) UploadThumbnail(id string, fileName string, fileReader io.Reader) (*ResponseSuccess, error) { 	return s.UploadThumbnailWithContext(context.Background(), id, fileName, fileReader)
}
 ...
 * @return VideoApiCreateCaptionRequest
 */
func (s *VideoService) CreateCaption(id string, lan string, fileName string, fileReader io.Reader) (*CreateVideoCaptionResponse, error) { 	return s.CreateCaptionWithContext(context.Background(), id, lan, fileName, fileReader)
}
 ...
 * @return VideoApiUploadPartRequest
 */
func (s *VideoService) UploadPart(id string, hash *string, index *string, fileName string, fileReader io.Reader, fileSize int64) (*ResponseSuccess, error) { 	return s.UploadPartWithContext(context.Background(), id, hash, index, fileName, fileReader, fileSize)
}
