 ...
 * @return VideoChapterApiCreateRequest
 */
func (s *VideoChapterService) Create(id string, lan string, fileName string, fileReader io.Reader) (*CreateVideoChapterResponse, error) { 	return s.CreateWithContext(context.Background(), id, lan, fileName, fileReader)
}
