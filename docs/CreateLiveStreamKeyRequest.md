...
`func (o *CreateLiveStreamKeyRequest) GetType() string`

GetType returns the Type field if non-nil, zero value otherwise.

### GetTypeOk

`func (o *CreateLiveStreamKeyRequest) GetTypeOk() (*string, bool)`
...
`func (o *CreateLiveStreamKeyRequest) SetType(v string)`

SetType sets Type field to given value.

### HasType

`func (o *CreateLiveStreamKeyRequest) HasType() bool`
