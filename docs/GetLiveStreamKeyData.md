...
`func (o *GetLiveStreamKeyData) GetType() string`

GetType returns the Type field if non-nil, zero value otherwise.

### GetTypeOk

`func (o *GetLiveStreamKeyData) GetTypeOk() (*string, bool)`
...
`func (o *GetLiveStreamKeyData) SetType(v string)`

SetType sets Type field to given value.

### HasType

`func (o *GetLiveStreamKeyData) HasType() bool`
