...
`func (o *LiveStreamKeyData) GetType() string`

GetType returns the Type field if non-nil, zero value otherwise.

### GetTypeOk

`func (o *LiveStreamKeyData) GetTypeOk() (*string, bool)`
...
`func (o *LiveStreamKeyData) SetType(v string)`

SetType sets Type field to given value.

### HasType

`func (o *LiveStreamKeyData) HasType() bool`
