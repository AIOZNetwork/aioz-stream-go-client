...
`func (o *UpdateLiveStreamKeyData) GetType() string`

GetType returns the Type field if non-nil, zero value otherwise.

### GetTypeOk

`func (o *UpdateLiveStreamKeyData) GetTypeOk() (*string, bool)`
...
`func (o *UpdateLiveStreamKeyData) SetType(v string)`

SetType sets Type field to given value.

### HasType

`func (o *UpdateLiveStreamKeyData) HasType() bool`
